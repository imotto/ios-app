...
func GetHumanDate(_ month: Int) -> String
{
...
//    func rangeOfPeriod(period: NSDateComponents) -> (NSDate, NSDate) {
//        
//        var startDate = NSDate()
//        var interval : NSTimeInterval = 0
//        let _ = NSCalendar.currentCalendar()
//        Calendar.current.dateInterval(of: period, start: &startDate, interval: &interval, for: self)
...
//    
    func isBigger(_ to: Date) -> Bool {
        return (Calendar.current as NSCalendar).compare(self, to: to, toUnitGranularity: .day) == .orderedDescending
    }
    
    func isSmaller(_ to: Date) -> Bool {
        return (Calendar.current as NSCalendar).compare(self, to: to, toUnitGranularity: .day) == .orderedAscending
    }
//
