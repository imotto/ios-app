...
var navigationBarExtKey: String = "coverView"
...
extension UINavigationBar {
    ...
    var coverView: UIView? {
        get {
            ...
            return objc_getAssociatedObject(self, &navigationBarExtKey) as? UIView
        }
        
        set {
            //与上面对应是重新设置这个对象，最后一个参数如果学过oc的话很好理解，就是代表这个newValue的属性
            //OBJC_ASSOCIATION_RETAIN_NONATOMIC意味着:strong,nonatomic
            objc_setAssociatedObject(self, &navigationBarExtKey, newValue, .OBJC_ASSOCIATION_RETAIN_NONATOMIC)
        }
    }
